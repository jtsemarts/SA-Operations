...
**Scope:** A two-week, low-risk trial of two Anthropic knowledge-work plugins in our company Claude/Cowork account: **Productivity** (mapped to Otto/EA) and **HR** (mapped to the HR agent). Draft-only, connector-free, human-approved throughout.
...
- **Week 1:** Productivity in daily use (Otto/EA); HR runs the offer + onboarding tests.
